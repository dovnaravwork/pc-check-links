(() => {
  ...
  function buildUsbPrepCommand(value) {
    ...
    return [
      ...
      "if($Source.Name -ne 'winget' -or $Source.Arg -ne 'https://cdn.winget.microsoft.com/cache' -or $Source.Identifier -ne 'Microsoft.Winget.Source_8wekyb3d8bbwe' -or $Source.TrustLevel -notcontains 'Trusted'){throw 'Источник winget изменён или не является доверенным — запуск отменён'}",
